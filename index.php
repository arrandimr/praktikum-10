	...
	<div class="card ">
				...
				<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" >
					<div class="container row">
    					...
    					<div class="col-sm">
							<span class="badge bg-info text-white text-wrap float-right" style="width: 6rem;"><h4 align="center">F-PD</h4></span>
    					</div>
  					</div>
			...
			<div class="form-group row float-right">
				<div class="col-sm-10">
					<button type="submit" class="btn btn-info" value="Get Selected Values">Simpan</button>
				</div>	
			</div>
					</form>
</div>
